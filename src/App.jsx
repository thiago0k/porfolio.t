      ...
      <div className='flex justify-center'>
        <header className='contenedor-headers fixed top-2 contenedor-header rounded-3xl p-5 h-1 hidden  sm:block'>
          <ul  className='flex h-full justify-center items-center list-none gap-5 text-white'>
            <li><a  onClick={() => handleClick(0)} className={`text-white itemsss cursor-pointer ${selectedIndex === 0 ? 'text-yellow-500' : 'text-white'}`}  href="#seccion1">Proyectos</a></li>
            <li><a  onClick={() => handleClick(1)} className={`text-white itemsss cursor-pointer ${selectedIndex === 1 ? 'text-yellow-500' : 'text-white'}`} href="#seccion2">Sobre Mi</a></li>
            <li     onClick={() => handleClick(2)} className={`text-white itemsss cursor-pointer ${selectedIndex === 2 ? 'text-yellow-500' : 'text-white'}`}>Contacto</li>
            <li
        ...
        <div className="parte-1"> 
            ...
            <button className="btn-disponible"><a className='text-white' href="mailto:tiagoelias289@gmail.com">Disponible para trabajar</a></button>
        </div>
        ...
        <button className='btn-1'><a className='text-white' href="C:\Users\thiago\Downloads\CV_thiago.pdf" download="C:\Users\thiago\Downloads\CV_thiago.pdf">Curriculum</a></button>
          <button className="contactame btn-1"><a className='text-white' href="mailto:tiagoelias289@gmail.com">Contactame</a></button>
         <a href="https://www.linkedin.com/in/tiago-elias-000389305/"><svg style={{ color: click ? '#322e52' : 'white' }} className="size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path><path d="M8 11l0 5"></path><path d="M8 8l0 .01"></path><path d="M12 16l0 -5"></path><path d="M16 16v-3a2 2 0 0 0 -4 0"></path></svg></a>
        </div>

        <div className='sm:hidden mt-7'>
        {/* <h1 style={{ color: click ? 'black' : 'gainsboro' }}  className='m-3'>Tecnologias</h1> */}
          <Tecnologias/>
          </div>
          ...
          {/* <div style={{ background: click ? 'white' : '#1e293b' }} id='seccion1' className='w-full min-h-screen'>hola</div>  */}
          <div style={{ backgroundColor: click ? 'white' : '#19192d' }} id='seccion1' className='min-h-screen'>
  <div className='flex justify-center'>
    <div className='w-full max-w-screen-lg min-h-screen'>
      <h1 className='mt-2 mb-8' style={{ color: click ? 'black' : 'gainsboro' }}>
...
<h1 style={cambiar} className="flex  gap-3">
...
<div className="lg:w-1/2 mt-8 lg:mt-0 lg:ml-8 m-3">
    <div className="thiagoelias border-solid flex justify-center border-gray-600 w-60 rounded-2xl p-1">
  ...
  <div className="lg:w-1/2">
    <div className="flex flex-col gap-7">
      ...
      <div>
        <p style={cambiar} className="text-lg">
...
function Proyectos( {cambio} ) {
  return(
    ...
    <div >
    <div className='bg-slate-500 h-60 md:h-full m-4 md:m-0  rounded-xl'><img className='w-[100%] object-cover md:w-[400px] h-full rounded-lg' src="https://www.porfolio.dev/projects/svgl.webp" alt="" /></div>
    </div>

    <div className='flex flex-col gap-3 m-4 md:w-[40%] '>
      <h2 style={cambio}>SVGL - A beautiful library with SVG logos</h2>
      <div className='flex gap-2 '>
      <button className='flex justify-center items-center gap-1 bg-slate-950 border-none w-28  hover:bg-slate-900 duration-500 cursor-pointer h-7 rounded-xl text-white'><svg className='w-4 ' xmlns="http://www.w3.org/2000/svg" width="2500" height="2500" viewBox="0 0 1052 1052"><path fill="#f0db4f" d="M0 0h1052v1052H0z"/><path d="M965.9 801.1c-7.7-48-39-88.3-131.7-125.9-32.2-14.8-68.1-25.399-78.8-49.8-3.8-14.2-4.3-22.2-1.9-30.8 6.9-27.9 40.2-36.6 66.6-28.6 17 5.7 33.1 18.801 42.8 39.7 45.4-29.399 45.3-29.2 77-49.399-11.6-18-17.8-26.301-25.4-34-27.3-30.5-64.5-46.2-124-45-10.3 1.3-20.699 2.699-31 4-29.699 7.5-58 23.1-74.6 44-49.8 56.5-35.6 155.399 25 196.1 59.7 44.8 147.4 55 158.6 96.9 10.9 51.3-37.699 67.899-86 62-35.6-7.4-55.399-25.5-76.8-58.4-39.399 22.8-39.399 22.8-79.899 46.1 9.6 21 19.699 30.5 35.8 48.7 76.2 77.3 266.899 73.5 301.1-43.5 1.399-4.001 10.6-30.801 3.199-72.101zm-394-317.6h-98.4c0 85-.399 169.4-.399 254.4 0 54.1 2.8 103.7-6 118.9-14.4 29.899-51.7 26.2-68.7 20.399-17.3-8.5-26.1-20.6-36.3-37.699-2.8-4.9-4.9-8.7-5.601-9-26.699 16.3-53.3 32.699-80 49 13.301 27.3 32.9 51 58 66.399 37.5 22.5 87.9 29.4 140.601 17.3 34.3-10 63.899-30.699 79.399-62.199 22.4-41.3 17.6-91.3 17.4-146.6.5-90.2 0-180.4 0-270.9z" fill="#323330"/></svg> Javascript</button>
      <button className="flex justify-center items-center gap-1 bg-slate-950 border-none w-24  h-7 hover:bg-slate-900 duration-500 cursor-pointer rounded-xl text-white"><svg className='w-4' viewBox="0 0 256 154" width="256" height="154" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid"><defs><linearGradient x1="-2.778%" y1="32%" x2="100%" y2="67.556%" id="gradient"><stop stopColor="#2298BD" offset="0%"></stop> <stop stopColor="#0ED7B5" offset="100%"></stop></linearGradient></defs><path d="M128 0C93.867 0 72.533 17.067 64 51.2 76.8 34.133 91.733 27.733 108.8 32c9.737 2.434 16.697 9.499 24.401 17.318C145.751 62.057 160.275 76.8 192 76.8c34.133 0 55.467-17.067 64-51.2-12.8 17.067-27.733 23.467-44.8 19.2-9.737-2.434-16.697-9.499-24.401-17.318C174.249 14.743 159.725 0 128 0ZM64 76.8C29.867 76.8 8.533 93.867 0 128c12.8-17.067 27.733-23.467 44.8-19.2 9.737 2.434 16.697 9.499 24.401 17.318C81.751 138.857 96.275 153.6 128 153.6c34.133 0 55.467-17.067 64-51.2-12.8 17.067-27.733 23.467-44.8 19.2-9.737-2.434-16.697-9.499-24.401-17.318C110.249 91.543 95.725 76.8 64 76.8Z"fill="url(#gradient)"></path></svg> Tailwind</button>
      </div>
      <div className=''>
     <p style={cambio} className='text-gray-400 leading-6'>Biblioteca de logos SVG de las marcas más populares. +10k visitas al mes. +2K svgs descargados. Creado desde cero con Next.js, React y Tailwind CSS.</p>
      </div>
      <div className='flex  gap-2'>
    <button className='flex justify-center items-center gap-1 bg-slate-950 border-none w-24 p-2 hover:bg-slate-900 duration-500 cursor-pointer h-10 rounded-md text-white'><svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-github"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg> Code</button>
    <button className="flex justify-center items-center gap-1 bg-slate-950 border-none w-24 p-2 h-10 hover:bg-slate-900 duration-500 cursor-pointer rounded-md text-white"><svg className='w-6 h-6' xmlns="http://www.w3.org/2000/svg" width="24" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg> Previw</button>
    </div>
    </div>
